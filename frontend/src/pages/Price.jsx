...
const Price = () => {
  return (
    <>
      <Box class="mainbox" mt={"150px"}>
        <Box className="heading-top" marginTop="80px">
          <Heading
            as="h2"
            size="2xl"
            noOfLines={1}
        ...
        <Box className="courese-box">
          <Box className="course-box-detail">
            ...
            <Heading
              ...
              marginLeft="-19px"
            >
              All features, plus best-in-class <br marginLeft="-50%" />{" "}
              integrations
            </Heading>
            <Heading
              color="#57BB71"
        ...
        <Box className="currency">
          <Flex>
            ...
            <Image
              ...
              marginTop="35px"
              marginLeft="8px"
              src="https://everhour.com/assets/images/flags/inr.png"
            />
            <Heading
              as="h5"
              size="sm"
              ...
              <Accordion allowToggle>
                ...
                <AccordionItem>
                  ...
                  <AccordionPanel pb={4} fontSize={16} color="#333333">
                    ...
                    minimum usage fee will apply. So it's either $50/month on a
